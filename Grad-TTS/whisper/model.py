...
class SharedEncoder(nn.Module):
    def __init__(self, n_mels: int, n_ctx: int, n_state: int, n_head: int, n_layer: int, n_accents: int = 4):
        super().__init__()
...
class Whisper(nn.Module):
    def __init__(self, dims: ModelDimensions, ctc_vocab: int = None, n_accents: int = 4):
        super().__init__()
        self.dims = dims
        ...
        # self.ctc_head = CTCHead(vocab_size=ctc_vocab)
        # self.accent_classifier = nn.Sequential(
