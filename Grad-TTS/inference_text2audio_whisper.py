...
from model import GradTTSConformer, GradTTSGST, GradTTSConformerGST, GradTTSConformerConvGST, GradTTSConformerGSTWhisper
...
def load_models(acoustic_checkpoint_path=None, mel_output_dir=None):
    ...
    generator = GradTTSConformerGSTWhisper(zh_dict.__len__() + 1, params.n_spks, params.spk_emb_dim,
...
if __name__ == "__main__":
    ...
    acoustic_checkpoint_path = '/home/xintong/Speech-Backbones/Grad-TTS/logs/new_exp_sg_acc_blank_conformer_gst_whisper_256/grad_5.pt'
