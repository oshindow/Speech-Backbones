...
import params
from model import GradTTSGST, GradTTSConformer, GradTTSConformerGST,  GradTTSConformerConvGST, GradTTSTransformerGST
...
log_dir = '/data2/xintong/gradtts/logs/new_exp_sg_acc_blank_conformer_gst_E21'
...
def run(rank, n_gpus):
    ...
    model = GradTTSTransformerGST(nsymbols, n_spks, spk_emb_dim, n_enc_channels,
