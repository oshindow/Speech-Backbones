...
import params
from model import GradTTS, GradTTSConformer, GradTTSConformerORI, GradTTSConformerORIConv
...
log_dir = '/data2/xintong/gradtts/logs/new_exp_sg_acc_blank_conformerconv_E17'
...
if __name__ == "__main__":
    ...
    model = GradTTSConformerORIConv(nsymbols, n_spks, spk_emb_dim, n_enc_channels,
