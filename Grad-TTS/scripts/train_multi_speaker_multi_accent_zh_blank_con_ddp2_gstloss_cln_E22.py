...
import params
from model import GradTTSGST, GradTTSConformer, GradTTSConformerGST,  GradTTSConformerConvGST, GradTTSConformerConvGSTFrame
...
log_dir = '/data2/xintong/gradtts/logs/new_exp_sg_acc_blank_conformer_gst_E22'
...
def run(rank, n_gpus):
    ...
    model = GradTTSConformerConvGSTFrame(nsymbols, n_spks, spk_emb_dim, n_enc_channels,
                    filter_channels, filter_channels_dp, 
                    n_heads, n_enc_layers, enc_kernel, enc_dropout, window_size, 
                    n_feats, dec_dim, beta_min, beta_max, pe_scale, n_accents, grl=False, gst=True, cln=False).cuda(rank)
    # print(model)
