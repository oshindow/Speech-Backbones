...
import params
from model import GradTTSGST, GradTTSConformer, GradTTSConformerGST,  GradTTSConformerConvGSTFullCLN
...
log_dir = '/data2/xintong/gradtts/logs/new_exp_sg_acc_blank_conformer_gst_E23'
...
pretrained_model = 'logs/new_exp_sg_acc_blank_conformer_gst_E18/grad_248.pt'
...
def run(rank, n_gpus):
    ...
    model = GradTTSConformerConvGSTFullCLN(nsymbols, n_spks, spk_emb_dim, n_enc_channels,
